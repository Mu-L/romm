...
Revision ID: 0124_rating_count_column
Revises: 0123_igdb_tag_columns
...
revision = "0124_rating_count_column"
down_revision = "0123_igdb_tag_columns"
branch_labels = None
depends_on = None
...
# in the order 0120 left them: PostgreSQL rejects one that moves a column.
_VIEW_COLUMNS = [
